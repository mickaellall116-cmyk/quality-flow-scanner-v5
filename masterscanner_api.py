...
def classify_symbol(symbol, theme, df, market_df, market_regime, timeframe):
    ...
    elif state in ["BUY","PULLBACK BUY","EARLY BUY"] and in_zone: entry="YES"
    elif state in ["BUY","PULLBACK BUY","EARLY BUY"] and near_zone: entry="WATCH"; note+=" | Near entry zone; wait for price"
